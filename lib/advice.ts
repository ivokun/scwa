...
const weatherAdvice: WeatherAdvice = {
  ...
  233: [
    ...
    "Avoid being outdoors, as hail can cause serious injury.",
    "Protect your head and body by covering up or finding a safe location.",
    "Be cautious of damaged or fallen power lines, and report any hazards to the authorities.",
    "Inspect your property for any damage after the storm has passed.",
  ],
  300: [
  ...
  520: [
    ...
    "Be cautious of slippery surfaces, especially on stairs or walkways.",
    "Avoid standing water, as it may conceal hazards.",
    "Consider postponing outdoor activities until the showers have passed.",
  ...
  521: [
    ...
    "Consider postponing or rescheduling any outdoor activities until the showers have passed.",
  ],
  522: [
    "Seek shelter in a sturdy building or vehicle immediately.",
    "Avoid areas prone to flooding, such as low-lying roads or underpasses.",
  ...
  610: [
    "Dress in layers and wear waterproof and warm clothing.",
    "Be cautious of slippery surfaces, including roads, sidewalks, and stairs.",
    "Avoid driving if possible, as the mix of snow and rain can make roads hazardous.",
    "Consider postponing or rescheduling outdoor activities until the mixed precipitation has passed.",
    "Monitor the weather and be prepared to seek shelter if the conditions worsen.",
  ],
  611: [
    "Seek shelter indoors and avoid going out if possible.",
  ...
  623: [
    "Dress warmly in layers and wear appropriate winter clothing.",
    "Be cautious of slippery surfaces, including roads, sidewalks, and stairs.",
    "Avoid driving if possible, as the flurries can make roads slightly hazardous.",
    "Consider postponing or rescheduling outdoor activities until the flurries have passed.",
    "Monitor the weather and be prepared to seek shelter if the conditions worsen.",
  ],
  700: [
...
function getWeatherAdvice(weatherCode: number): string[] {
  if (weatherAdvice[weatherCode]) {
    return weatherAdvice[weatherCode];
  } else {
